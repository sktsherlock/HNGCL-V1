...
from pHNGCL.model import Encoder, GRACE
...
from pHNGCL.utils import generate_feature_graph_edge_index, get_base_model, get_activation, \
...
def train():
    ...
    loss = model.loss(z1, z2, batch_size=256 if args.dataset == 'Coauthor-Phy' else None)
    loss.backward()
    optimizer.step()
...
if __name__ == '__main__':
    ...
    feature_graph_edge_index = generate_feature_graph_edge_index(data.x, args.k)
